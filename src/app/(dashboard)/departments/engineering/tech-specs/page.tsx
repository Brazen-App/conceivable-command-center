...
const SPECS: SpecEntry[] = [
  ...
  {
    id: "perimenopause-prediction",
    title: "Perimenopause Prediction Algorithm Specification",
    experience: "Perimenopause",
    experienceSlug: "perimenopause",
    accentColor: "#D4944A",
    icon: "🔥",
    href: "/departments/product/experiences/perimenopause/prediction-algorithm",
    status: "complete",
    wordCount: 3200,
    lastUpdated: "2026-03-12",
    components: [
      "Perimenopause Prediction Engine",
      "Follicular BBT Analysis Module",
      "Cycle Variability Tracker",
      "HRV Trajectory Analyzer",
      "Sleep Architecture Monitor",
      "Thermoregulatory Event Detector",
      "Lab Integration System",
    ],
    sections: [
      "Purpose & Clinical Basis",
      "Primary Signal: Follicular Phase BBT Elevation (30% weight)",
      "Secondary Signals: Cycle Variability, HRV, Sleep, Vasomotor (60% combined)",
      "Tertiary Signals: Self-Reported Indicators (10%)",
      "Algorithm Output: Transition Likelihood Levels (0-4)",
      "Baseline Comparison Advantage",
      "Day 3 Lab Integration",
      "Patent 021 Coverage",
    ],
  },
  {
    id: "first-period-prediction",
    title: "First Period Prediction Algorithm Specification",
    experience: "First Period",
    experienceSlug: "first-period",
    accentColor: "#F4A7B9",
    icon: "🌸",
    href: "/departments/product/experiences/first-period/prediction-algorithm",
    status: "complete",
    wordCount: 2800,
    lastUpdated: "2026-03-12",
    components: [
      "Menarche Prediction Engine",
      "Developmental Marker Assessment",
      "Family History Analyzer",
      "Prediction Window Generator",
      "Standalone Quiz Engine",
    ],
    sections: [
      "Purpose & Lead Generation Context",
      "Input Factors: Age, Family History, Breast Development (50% combined)",
      "Input Factors: Growth Spurt, Discharge, Body Hair, Skin, Composition (50% combined)",
      "Algorithm Output: Prediction Window",
      "Output Display: Age-Appropriate Visualization",
